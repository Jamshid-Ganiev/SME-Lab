...
class Metaclass_FleetManagement_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('dynamic_fleet_manager')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'dynamic_fleet_manager.action.FleetManagement_Goal')
            logger.debug(
...
class FleetManagement_Goal(metaclass=Metaclass_FleetManagement_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.fleet_data = kwargs.get('fleet_data', [])
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.fleet_data != other.fleet_data:
            return False
        return True
    ...
    @builtins.property
    def fleet_data(self):
        """Message field 'fleet_data'."""
        return self._fleet_data

    @fleet_data.setter
    def fleet_data(self, value):
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'fleet_data' field must be a set or sequence and each value of type 'str'"
        self._fleet_data = value
...
class Metaclass_FleetManagement_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dynamic_fleet_manager.action.FleetManagement_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_FleetManagement_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dynamic_fleet_manager.action.FleetManagement_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FleetManagement_SendGoal_Request(metaclass=Metaclass_FleetManagement_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'dynamic_fleet_manager/FleetManagement_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['dynamic_fleet_manager', 'action'], 'FleetManagement_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from dynamic_fleet_manager.action._fleet_management import FleetManagement_Goal
...
class Metaclass_FleetManagement_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dynamic_fleet_manager.action.FleetManagement_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dynamic_fleet_manager.action import _fleet_management
...
class FleetManagement_SendGoal(metaclass=Metaclass_FleetManagement_SendGoal):
    from dynamic_fleet_manager.action._fleet_management import FleetManagement_SendGoal_Request as Request
    from dynamic_fleet_manager.action._fleet_management import FleetManagement_SendGoal_Response as Response
...
class FleetManagement_GetResult_Response(metaclass=Metaclass_FleetManagement_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'dynamic_fleet_manager/FleetManagement_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['dynamic_fleet_manager', 'action'], 'FleetManagement_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from dynamic_fleet_manager.action._fleet_management import FleetManagement_Result
...
class Metaclass_FleetManagement_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dynamic_fleet_manager.action.FleetManagement_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FleetManagement_GetResult(metaclass=Metaclass_FleetManagement_GetResult):
    from dynamic_fleet_manager.action._fleet_management import FleetManagement_GetResult_Request as Request
    from dynamic_fleet_manager.action._fleet_management import FleetManagement_GetResult_Response as Response
...
class Metaclass_FleetManagement_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dynamic_fleet_manager.action.FleetManagement_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FleetManagement_FeedbackMessage(metaclass=Metaclass_FleetManagement_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'dynamic_fleet_manager/FleetManagement_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['dynamic_fleet_manager', 'action'], 'FleetManagement_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from dynamic_fleet_manager.action._fleet_management import FleetManagement_Feedback
...
class Metaclass_FleetManagement(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dynamic_fleet_manager.action.FleetManagement')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FleetManagement(metaclass=Metaclass_FleetManagement):
    ...
    from dynamic_fleet_manager.action._fleet_management import FleetManagement_Goal as Goal
    # The result message defined in the action definition.
    from dynamic_fleet_manager.action._fleet_management import FleetManagement_Result as Result
    # The feedback message defined in the action definition.
    from dynamic_fleet_manager.action._fleet_management import FleetManagement_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from dynamic_fleet_manager.action._fleet_management import FleetManagement_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from dynamic_fleet_manager.action._fleet_management import FleetManagement_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from dynamic_fleet_manager.action._fleet_management import FleetManagement_FeedbackMessage as FeedbackMessage
